...
<head>
    ...
    <meta name="description" content="Charmed Plume Productions est une association à but non-lucratif qui vise à créer des évènements immersifs" />
    <meta name="author" content="Antoine Pascual" />
...
<div class="background_img">
	<img src="assets/img/background.png" alt="background_img" class="img-fluid" id="background_img">
...
<div class="card border-primary mb-3" style="max-width: 20rem;" id="seemom1">
  <div class="card-header">Meeting of Monarchs</div>
  <div class="card-body">
    <h4 class="card-title">23 - 26 SEPTEMBRE 2021</h4>
    <p class="card-text"><img src="assets/img/logo_MOM.png" alt="" width="250px" id="mom_logo"></p>

  </div>
</div></div>

		<div class="col-sm">
			<div class="card border-primary mb-3" style="max-width: 20rem;" id="seemom2">
  <div class="card-header">Meeting of Monarchs 2</div>
  <div class="card-body">
    <h4 class="card-title">26 - 29 MAI 2022</h4>
    <p class="card-text"><img src="assets/img/logo_MOM.png" alt="" width="250px" id="mom_logo"></p>
  </div>
</div></div>
<div class="col-sm">
			<div class="card border-primary mb-3" style="max-width: 20rem;" id="seeacademiedemagie">
...
<h3><strong>26 - 29 Mai 2022</strong></h3>
<br><hr>
<p>Nous sommes en l'an de grâce 1520, deux des rois les plus connus de la Renaissance se rencontrent pour la toute première fois. Henry VIII d'Angleterre ey François 1er de France vous souhaitent la bienvenue, au Camp du Drap d'Or !</p>
...
<br><hr>
<p>Baronnies - Académie de Magie est un jeu de rôle immersif (GN) inspiré par Harry Potter. Cependant, Baronnies vous invite à devenir étudiant de la magie à un niveau universitaire et propose donc des scénarios plus matures que l'école de magie dans le même univers imaginaire "College of Wizardry".</p>

<p>Baronnies est similaire aux universités Ivy League du monde des moldus, et donc seul les plus talentueux, ou les plus riches et influentes sont acceptées.</p>
...
$("#backfrommom2").click(function(){
	$("#mom2").hide("slow");	
		$("#cards").show("slow");
		
})

$("#seeacademiedemagie").click(function(){
		$("#cards").hide("slow");
		$("#academiedemagie").show("slow");
	
	
});

$("#backfromacademiedemagie").click(function(){
	$("#academiedemagie").hide("slow");	
		$("#cards").show("slow");
